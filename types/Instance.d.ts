interface Instance extends RBXObject {
  WaitForChild<K extends ExtractKeys<this, Instance>>(childName: K): this[K];
  WaitForChild<K extends ExtractKeys<this, Instance>>(childName: K, timeout: number): Maybe<this[K]>;
  ...
  FindFirstChild<K extends ExtractKeys<this, Instance>>(childName: K, recursive?: boolean): this[K];
